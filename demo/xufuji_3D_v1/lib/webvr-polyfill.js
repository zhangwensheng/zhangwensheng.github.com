...
FusionPositionSensorVRDevice.prototype.getOrientation = function() {
  if(device == "screenMove"){
    return this.touchPanner.getOrientationByTouch();
  }
  ...
  out.copy(this.filterToWorldQ);  //reset scene
...
MouseKeyboardPositionSensorVRDevice.prototype.onMouseMove_ = function(e) {
  ...
  this.phi += 2 * Math.PI * this.rotateDelta.y / element.clientHeight * MOUSE_SPEED_X;
  this.theta += 2 * Math.PI * this.rotateDelta.x / element.clientWidth * MOUSE_SPEED_Y;
...
TouchPanner.prototype.getOrientationByTouch = function() {
  this.orientation.setFromEuler(new THREE.Euler(this.phi, this.theta,0,'YXZ'));
  return this.orientation;
};
...
TouchPanner.prototype.onTouchStart_ = function(e) {
  ...
  this.rotateStart.set(e.touches[0].screenX, e.touches[0].screenY);
...
TouchPanner.prototype.onTouchMove_ = function(e) {
  ...
  this.rotateEnd.set(e.touches[0].screenX, e.touches[0].screenY);
  this.rotateDelta.subVectors(this.rotateEnd, this.rotateStart);
  this.rotateStart.copy(this.rotateEnd);
