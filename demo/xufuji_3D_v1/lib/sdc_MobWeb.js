function _wt() {
    this.u = "http" + (window.location.protocol.indexOf('https:') == 0 ? 's' : '') + "://dt.yum.com.cn/dcswownlk00000kfd8ufharod_1q2m/dcs.gif?WT.branch=WeChat_PHDI";
    this.p = "";
    this.t = "";
    this.WT = {};
    this.z = true;
...
_wt.prototype.M = function () {
    var $a;
    if (document.all)$a = document.all.tags("meta"); else if (document.documentElement)$a = document.getElementsByTagName("meta");
...
_wt.prototype.trackEvent = function () {
    ...
    if (document.body.addEventListener)document.body.addEventListener(e, this.K.wtbind(this), true); else if (document.body.attachEvent)document.body.attachEvent("on" + e, this.K.wtbind(this));
};
